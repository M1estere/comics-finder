...
if ( ! function_exists( 'minimalio_latest_posts' ) ) {
	function minimalio_latest_posts() {
		if ( 'post' === get_post_type() ) {
			...
			printf( '<h3 class="p-0 mb-8">' . esc_html__( 'Latest', 'minimalio' ) . '</h3>' );
	...
	function minimalio_latest_portfolio_posts() {
		if ( 'portfolio' === get_post_type() ) {
			...
			minimalio_get_part( 'templates/blocks/posts-ajax/posts-ajax',
				[
					'nr_post'           => '4',
					'nr_columns'        => get_theme_mod( 'minimalio_settings_portfolio_columns' ),
					'pagination_option' => 'pagination',
					'post_type'         => 'portfolio',
					'post_card'         => $post_card,
					'author_type'       => 'author-1',
...
if ( ! function_exists( 'minimalio_post_nav' ) ) {
	function minimalio_post_nav() {
		...
		?>
		<nav class="p-0 navigation post-navigation">
