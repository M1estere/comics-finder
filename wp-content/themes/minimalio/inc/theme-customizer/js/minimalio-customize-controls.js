...
(function () {
	...
	wp.customize.bind('ready', function () {
		...
		// wp.customize('minimalio_settings_footer_widgets', function(setting) {
		// 	wp.customize.control('minimalio_footer_options_footer_background', function(control) {
		// 		var visibility = function() {
		// 			if ('yes' === setting.get()) {
		// 				control.container.slideDown(180);
		// 			} else {
		...
		// Only show copyright settings when enabled
		// wp.customize('minimalio_settings_footer_widgets', function(setting) {
		// 	wp.customize.control('minimalio_footer_options_footer_font_color', function(control) {
		// 		var visibility = function() {
		// 			if ('yes' === setting.get()) {
		// 				control.container.slideDown(180);
		// 			} else {
